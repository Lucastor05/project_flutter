...
class NewHorse extends StatefulWidget {
  const NewHorse({super.key, required this.title});
  final String title;

  @override
  State<NewHorse> createState() => _NewHorseState();
}

class _NewHorseState extends State<NewHorse> {
                ...
                TextButton(
                  onPressed: () async {
                    if (_formKey.currentState!.validate()) {
                      if (photoPath != null) {
                        final success = await HorseController.set(
                          photoPath!,
                          nameController.text,
                        ...
                        if (success) {
                          ...
                          print("Erreur pendant l'enregistrement");
                        }
                      } else {
