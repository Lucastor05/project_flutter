            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  if (soireeData?[index]['isValidated']) {
                    return Card(
                      child: ListTile(
                        subtitle: Row(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text('Nom: ${soireeData?[index]['name'] ??
                                      ''}'),
                                  Text('Date : Le ${soireeData?[index]['date']!
                                      .day}/${soireeData?[index]['date']!
                                      .month}/${soireeData?[index]['date']!
                                      .year} à ${soireeData?[index]['date']!
                                      .hour}:${soireeData?[index]['date']!
                                      .minute}'),
                                  Row(
                                    children: [
                                      TextButton(
                                        onPressed: () {
                                          Navigator.pushNamed(
                                              context, '/registerSoiree',
                                              arguments: soireeData?[index]['_id']
                                                  .toHexString());
                                        },
                                      ...
                                      if (isGerant) // Affichez le bouton "Supprimer" uniquement si l'utilisateur est un gérant
                                        TextButton(
                                          onPressed: () async {
                                            if (await NightController
                                                .deleteSoiree(
                                                soireeData?[index]['_id']
                                                    .toHexString())) {
                                              ...
                                              ScaffoldMessenger.of(context)
                                                  .showSnackBar(
                                                const SnackBar(content: Text(
                                                    'Erreur lors de la suppression de la soiree')),
                                              );
                                            }
                                          },
                  ...
                  }else if(isGerant && !soireeData?[index]['isValidated']){
                    return Card(
                      child: ListTile(
                        subtitle: Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      TextButton(
                                        onPressed: () async {
                                          if (await NightController.validate(soireeData?[index]['_id'].toHexString())) {
                                            ScaffoldMessenger.of(context).showSnackBar(
                                              const SnackBar(content: Text('Soiree validé')),
                                            );
                                            ...
                                            ScaffoldMessenger.of(context)
                                                .showSnackBar(
                                              const SnackBar(content: Text(
                                                  'Erreur lors de la validation de la soiree')),
                                            );
                                          }
                                        },
